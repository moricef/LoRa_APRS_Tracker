...
#include "tft.hpp"
#include "gpsMath.hpp"
#include "settings.hpp" // Include the project's settings definitions
#include "compass.hpp" // Include the project's compass definitions
#include "mapVars.h" // Include the project's map variables definitions
#include "storage.hpp" // Include the project's storage wrapper
