...
function loadSettings(settings) {
    ...
    const bluetooth = settings.bluetooth || {}; setChecked("bluetooth.active", bluetooth.active); setValue("bluetooth.deviceName", bluetooth.deviceName ?? "LoRaTracker"); setChecked("bluetooth.useBLE", bluetooth.useBLE); setChecked("bluetooth.protocol.tnc2", !bluetooth.useKISS); setChecked("bluetooth.protocol.kiss", bluetooth.useKISS); if (bluetooth.hasBTClassic === false && byId("btClassicOption")) byId("btClassicOption").style.display = "none"; updateBluetoothFields();
...
function updateBluetoothFields() { const active = byId("bluetooth.active").checked; setDisabled("bluetooth.deviceName", !active); setDisabled("bluetooth.useBLE", !active); setDisabled("bluetooth.protocol.tnc2", !active); setDisabled("bluetooth.protocol.kiss", !active); }
